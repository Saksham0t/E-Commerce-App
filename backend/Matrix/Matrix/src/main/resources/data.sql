...
INSERT INTO product (id, name, price, category, description, image_url) VALUES
    ...
    (259,'Lip Balm',300,'Beauty','Moisturizing lip balm that keeps your lips soft and hydrated all day. Enriched with natural oils for smooth and healthy lips.','https://tse4.mm.bing.net/th/id/OIP.Y9tj96Fzr5MVDdxW19nFjAHaHa?w=196&h=195&c=7&r=0&o=7&dpr=1.5&pid=1.7&rm=3'),
    (260,'Electric Iron',1200,'Electronics','High-quality electric iron with adjustable temperature settings for smooth and wrinkle-free clothes. Lightweight and easy to use for everyday ironing needs.','https://tse4.mm.bing.net/th/id/OIP.gUxrDnlYFLfQytpLk4FfGwHaFj?w=667&h=500&rs=1&pid=ImgDetMain&o=7&rm=3'),
    ...
    (270,'Leather Belt',900,'Accessories','High-quality leather belt with a stylish buckle. Durable and perfect for formal attire.','https://tse2.mm.bing.net/th/id/OIP.rDAUfG3idCYJh8QtaJOYKwHaE6?rs=1&pid=ImgDetMain&o=7&rm=3'),
    (271,'Sunglasses',1200,'Accessories','Trendy UV-protected sunglasses for outdoor wear. Lightweight and stylish design.','https://images.unsplash.com/photo-1503341455253-b2e723bb3dbb'),
    (272,'Wallet',1100,'Accessories','Compact leather wallet with multiple compartments for cards and cash. Elegant and durable.','https://img.freepik.com/premium-photo/designer-leather-wallets-4k-image-downloaded_555090-12925.jpg'),
